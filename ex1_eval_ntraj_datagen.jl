""" Script to generate evaluation data for experiment 1 to assess accuracy vs n_traj.
This is similar data to the training data in experiment1_train_datagen.jl but with n_traj = 10.
...
# Save the data!
folderpath = "data/ex1/"
filepath = folderpath * "ex1_eval_ntraj_data.hdf"
